...
export default function FlipCard({
  ...
  return (
    <div className="education-card-container">
      ...
      <div className="relative w-80 h-80 mx-auto perspective group">
        ...
        <div className="w-full h-full transition-transform duration-700 transform-style-preserve-3d group-hover:rotate-y-180 cursor-pointer relative z-20">
          ...
          {/* Back (Details) */}
          <div className="absolute w-full h-full backface-hidden rotate-y-180 flex flex-col items-center justify-center bg-slate-800/90 backdrop-blur-sm border border-slate-700/50 rounded-2xl shadow-xl p-6 text-slate-100">
