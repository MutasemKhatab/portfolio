...
export default function Skills() {
  return (
    <section className="py-12 text-center relative">
      <h2 className="text-3xl font-bold mb-16 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-8 relative z-10">
          {/* Frontend Branch */}
          <div className="branch-card frontend-branch w-64 transition-all duration-300 ease-in-out">
          ...
          {/* Backend Branch */}
          <div className="branch-card backend-branch w-64 transition-all duration-300 ease-in-out">
            <div className="bg-black bg-opacity-50 hover:bg-opacity-70 p-6 rounded-lg shadow-lg hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
          ...
          {/* DevOps Branch */}
          <div className="branch-card devops-branch w-64 transition-all duration-300 ease-in-out">
            <div className="bg-black bg-opacity-50 hover:bg-opacity-70 p-6 rounded-lg shadow-lg hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
